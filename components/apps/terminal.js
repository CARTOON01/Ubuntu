...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            skills: ["Front-end development", "React.js", "jQuery", "Flutter", "Express.js", "SQL", "MongoDB"],
            projects: ["Brian-Ngugi-personal-portfolio", "synonyms-list-react", "economist.com-unlocked", "Improve-Codeforces", "flutter-banking-app", "Meditech-Healthcare", "CPU-Scheduling-APP-React-Native"],
            interests: ["Software Engineering", "Machine Learning", "Cloud Computing"],
            languages: ["Javascript", "C++", "JavaScript", "Python", "C"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">kali@kali</div>
        ...
        switch (main) {
            ...
            case "code":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-Brian, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-Brian":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-Brian");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-Brian, todoist, trash, settings, sendmsg ]";
                }
                break;
