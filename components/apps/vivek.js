            ...
            <div className="w-full md:w-10/12 flex justify-center items-start font-bold text-center">
                <div className="px-2 w-1/2">
                    <div className="flex flex-wrap justify-center items-start w-full mt-2">
                        ...
                        <img className="m-1" src="https://img.shields.io/badge/Shell-0175C2?style=flat&logo=shell&logoColor=white" alt="vivek shell" />
                        ...
                        <img src="https://img.shields.io/badge/-MongoDB-FFCA28?style=flat&logo=mongodb&logoColor=ffffff" alt="vivek mongodb" className="m-1" />
                    </div>
                </div>
                <div className="px-2 flex flex-wrap items-start w-1/2">
                    <div className="flex flex-wrap justify-center items-start w-full mt-2">
                        ...
                        <img className="m-1" src="https://img.shields.io/badge/Flask-02569B?style=flat&logo=flask&logoColor=white" alt="vivek Flask" />
